...
const BP_MEDIUM = 550;
const BP_LARGE = 700;
const BODY_COPY = `I'm Adarsh. India-based internet enthusiast, creative technologist and maker of digital ephemera.`;
  ...
  const html = /*html*/ `
		<div class="wrapper grid label">
			...
			<div class="contributions fade-in">
				<span class="shine">${props.contributions.toFixed(1)}</span> Contributions
			</div>
